...
if (maxConcurrency > 1) {
    debug(`Note: Running parallel runs of lighthouse is not recommended unless you've got a crazy beefed up machine with plenty of cores and memory. See https://github.com/GoogleChrome/lighthouse/issues/7187 for more information.`);
}
if (configPath) {
    debug(`Using configuration at ${configPath}`);
}
appInsights.setup().start();
const lighthouseTask = (props) => tslib_1.__awaiter(this, void 0, void 0, function* () {
